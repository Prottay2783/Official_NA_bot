...
bot.on("message", async message => {
  ...
  if(command === "kick") {
    ...
    if(!message.member.roles.some(r=>["NITRO+", "NITRO" , "░+ИД | Co-Owners░", "╰☆ Head of All Staffs ☆╮", "╰☆ +ИД | Senior Staff Team ☆╮", "╰☆ +ИД | Staff Team ☆╮", "╰☆ +ИД | Intern ☆╮"].includes(r.name)) )
  ...
  if(command === "ban") {
    ...
    if(!message.member.roles.some(r=>["NITRO+", "NITRO" , "░+ИД | Co-Owners░", "╰☆ Head of All Staffs ☆╮", "╰☆ +ИД | Senior Staff Team ☆╮"].includes(r.name)) )
      return message.reply("Sorry, you don't have permissions to use this!");
